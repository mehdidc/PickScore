...
#! Name of the job:
#SBATCH -J pickscore_training_compositionality_pickapic_filtering
...
accelerate launch --dynamo_backend no --gpu_ids all --num_processes 3  --num_machines 1 --use_deepspeed /home/vu214/PickScore/trainer/scripts/train.py +experiment=compositionality_pickapic output_dir=/rds/project/rds-lSmP1cwRttU/vu214/reward-models-compositionality-resources/pickscore_trained_model_outputs_pickapic_dataset_filtering
